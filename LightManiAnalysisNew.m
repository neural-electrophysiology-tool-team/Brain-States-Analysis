...
t_ch = stimTable.StimTrighCh(i);
 ...
 stimEndT = T.tTrig{t_ch}(end);
AC= SA.getDelta2BetaAC;
parts ={[AC.tStartSleep,stimStartT],[stimStartT,stimEndT], [stimEndT,AC.tEndSleep]};
...
headAngAvgTh = HeadAngleAvg(inds,:);

% recordings startin with 60: 1 3 7 8 
% to flip:
flipInd = 1:4;
headAngAvgTh(flipInd,:) = 180 - headAngAvgTh(flipInd,:);
