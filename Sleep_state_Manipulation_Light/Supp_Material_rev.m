...
fileName=[analysisFolder filesep 'SWRcroswhiteNights'];
print(fileName,'-dpdf','-r300');

%% Supplementary Figure 3 - head angle raw
%% Sup 3A
 p = 1000*60*45;
...
%% Supplementary Figure 4 - intesnsity behivoiral:
%% Supp4A - intensity shifts: delta2beta in SW change
...
%% Supp 4B - intensity shifts: head mov:
clearvars -except stimTable SA LMData animalsColors uniqueAnimals analysisFolder stimWaveL Animals
...
%% Supp 4C- intensity shifts: head angle SD:
clearvars -except stimTable SA LMData animalsColors uniqueAnimals analysisFolder stimWaveL Animals
...
%% Supplementary Figure 5- Third eye Supplamentary figure:
...
%% Suuplementary Figure 6- eyelid supplamentry:
...
% plot
figure; plot(spectro1.nm,nspectro1,color='k')
...
%% Supplementary Figure 8 - internal red SWR
%% Sup 8A
i = 17;%(17 before). not PV106,N20
recName = ['Animal=' stimTable.Animal{i} ',recNames=' stimTable.recNames{i}];
SA.setCurrentRecording(recName);
stims = SA.getStimTriggers; %stimulations timimng in ms
firstTrig = stims(1:8:end);
...
%save
set(gcf ,'PaperPosition',[1 2 4.3 1.7]);
fileName=[analysisFolder filesep 'SWRraw_rev_red'];
% print(fileName,'-depsc','-vector');
print(fileName, '-dpdf', '-r300');
...
% save figure
set(fraw ,'PaperPosition',[1 2 4.3 1.7]);
fileName=[analysisFolder filesep 'SWRhist_rev_red'];
% print(fileName,'-depsc','-vector');
print(fileName, '-dpdf', '-r300');
