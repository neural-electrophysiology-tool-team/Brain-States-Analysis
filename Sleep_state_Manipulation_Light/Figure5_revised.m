...
stimType = ["Blue","Green","Red"];
stimWaveL = ["47","532","635"];
...
fileName=[analysisFolder filesep 'LaserMeanNormBDStimSham'];
...
fileName=[analysisFolder filesep 'LaserACperiodstimAll'];
print(fileName,'-dpdf',['-r' num2str(SA.figResJPG)]);
...
hold on; scatter(1:numType,means,'k','Marker','+')
...
fileName=[analysisFolder filesep 'LaserP2V156n'];
print(fileName,'-dpdf',['-r' num2str(SA.figResJPG)]);
%
...
fileName=[analysisFolder filesep 'LaserDBdecreaseDiffAllnigthscolors'];
print(fileName,'-dpdf',['-r' num2str(SA.figResJPG)]);
...
fileName=[analysisFolder filesep 'LaserheadAngleSDalltypesDiffs'];
print(fileName,'-dpdf',['-r' num2str(SA.figResJPG)]);
...
xticks(1:numType), xticklabels(stimType); xlim([0.7 4.3]); %ylim([0 10]);
...
fileName=[analysisFolder filesep 'LaserLMdiffs'];
print(fileName,'-dpdf',['-r' num2str(SA.figResJPG)]);
